...
const BUSINESS_TYPES: BusinessTypeItem[] = [
  ...
  {
    id: 'real-estate',
    icon: <House size={28} aria-hidden="true" />,
    title: 'Real Estate',
  ...
  {
    id: 'manufacturing',
    icon: <Factory size={28} aria-hidden="true" />,
    title: 'Manufacturing',
