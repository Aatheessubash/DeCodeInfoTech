...
export const INITIAL_PROJECTS: Project[] = [
  {
    ...
    problem:
      'A video-based online learning platform built for structured course delivery, interactive quizzes, and seamless student progress tracking.',
    solution:
      'A streamlined digital learning experience for structured video courses and student lifecycle management.',
  ...
  },
  {
    ...
    problem:
      'Real-time multi-counter point-of-sale and kitchen order ticketing (KOT) billing system built for high-throughput hospitality operations.',
    solution:
      'An ultra-fast cloud POS system with live menu configuration, billing printers, and real-time sales reporting.',
...
export const INITIAL_JOB_POSTINGS: JobPosting[] = [
  {
    ...
    icon: 'FS',
    summary:
      'Build high-performance web applications using React.js, Next.js, Node.js, and modern cloud deployment pipelines.',
    requirements: [
  ...
  },
  {
    ...
    icon: 'UI',
    summary:
      'Craft high-converting, aesthetically stunning user interfaces and micro-animations for enterprise and startup clients.',
    requirements: [
  ...
  },
  {
    ...
    icon: 'FE',
    summary:
      'Specialize in building ultra-fast responsive user interfaces, animations, and Core Web Vitals optimization.',
    requirements: [
